...
module.exports = async (req, res) => {
    if (req.method === "GET") {
        ...
        // we have two post methods, one for /x, and one for /x/y
        try {

            const { postId, commentId } = req.query; // check if the JSON for this is correct later lol, it might not be
